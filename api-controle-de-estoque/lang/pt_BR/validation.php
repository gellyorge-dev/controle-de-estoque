...
return [
    ...
    'attributes' => [
        ...
        'espaco_armazenamento_id' => 'Espaço de armazenamento',
        'marca_equipamento_id' => 'Marca',
        'tipo_equipamento_id' => 'Tipo de equipamento',
        'condicao_operacional_equipamento_id' => 'Condição operacional',
        'arquivo_imagem_id' => 'Arquivo de imagem',
        'nome_equipamento' => 'Nome do equipamento',
        'descricao_equipamento' => 'Descrição do equipamento',
        'informado_ao_patrimonio' => 'Informado ao patrimônio',
        'local_anterior' => 'Local anterior',
        'destino' => 'Destino',
        'observacoes_equipamento' => 'Observações',
        ...
        'login_usuario' => 'Login',
        'senha_usuario' => 'Senha',
        'unidade_organizacional_id' => 'Unidade organizacional',
        'unidade_id' => 'Unidade organizacional',
    ],
